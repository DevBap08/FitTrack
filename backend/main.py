...
app.add_middleware(
    ...
    allow_origins=[
        ...
        "https://project-eqm8o-git-main-bapbaps-projects.vercel.app", # Vercel preview/branch URL example
    ],
...
async def login_for_access_token(db: Session = Depends(get_db), form_data: OAuth2PasswordRequestForm = Depends()):
    ...
    print(f"Login successful for user: {form_data.username}. Token expires in {auth.ACCESS_TOKEN_EXPIRE_MINUTES} minutes.")
